...
public class SpamText : ScriptableObject
{
    ...
    string[] spam = {
        "Hello this is Grandmeister Bank. We are here to inform you that you have 454 dolllars of debt. Please contact within the 24 hours or we will take away your steam account.",
